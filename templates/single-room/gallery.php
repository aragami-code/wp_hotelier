...
if ( ! mbh_get_option( 'room_lightbox', true ) || ! $room->get_gallery_attachment_ids() ) {
...
<?php if ( $gallery_images ) :
	...
	<div class="room__gallery room__gallery--single">
		...
		<a href="#" class="room__gallery-link room__gallery-link--single" data-index="0"><?php esc_html_e( 'View room gallery', 'wp-mb_hms' ); ?></a>
