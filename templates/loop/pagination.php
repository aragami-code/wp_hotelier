...
<nav class="mb_hms-pagination pagination">
	<h2 class="screen-reader-text"><?php esc_html_e( 'Posts navigation', 'wp-mb_hms' ); ?></h2>

	<?php
	$big = 999999999; // need an unlikely integer

	$pages = paginate_links( apply_filters( 'mb_hms_pagination_args', array(
