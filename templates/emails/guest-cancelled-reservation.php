...
<tr>
	<td style="text-align:left;font-size:15px;line-height:19px;color:#999999;font-family:Helvetica,Arial;"><?php printf( esc_html__( 'Hello %s, your reservation has been cancelled. The reservation was as follows.', 'wp-mb_hms' ), $reservation->get_formatted_guest_full_name() ); ?></td>
</tr>
<tr>
