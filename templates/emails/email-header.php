											...
											<tr>
												<td bgcolor="#FFFFFF" style="background:#fff;border-radius:6px;font-family:Helvetica,Arial;">
													<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" style="margin:0px;padding:0px;border:0px;margin:0;padding:0;font-family:Helvetica,Arial;">
														<tbody>
															<?php if ( mbh_get_option( 'emails_logo' ) ) : ?>
															<tr>
																<td style="text-align:left;font-size:22px;line-height:32px;color:#444444;font-weight:bold;font-family:Helvetica,Arial;"><img src="<?php echo esc_url( mbh_get_option( 'emails_logo' ) ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>"></td>
															</tr>
															<tr>
																<td>&nbsp;</td>
															</tr>
