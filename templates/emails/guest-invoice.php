...
<?php if ( $reservation->has_status( 'pending' ) ) :
	...
	if ( $reservation->needs_payment() ) : ?>
		<tr>
			<td style="text-align:left;font-size:15px;line-height:19px;color:#999999;font-family:Helvetica,Arial;"><?php printf( esc_html__( 'Hello %s, a reservation has been created for you on %s. To pay for this reservation please use the button below.', 'wp-mb_hms' ), $reservation->get_formatted_guest_full_name(), get_bloginfo( 'name', 'display' ) ); ?></td>
		</tr>
	<?php else : ?>
		<tr>
			<td style="text-align:left;font-size:15px;line-height:19px;color:#999999;font-family:Helvetica,Arial;"><?php printf( esc_html__( 'Hello %s, a reservation has been created for you on %s.', 'wp-mb_hms' ), $reservation->get_formatted_guest_full_name(), get_bloginfo( 'name', 'display' ) ); ?></td>
		</tr>
	<?php endif; ?>
