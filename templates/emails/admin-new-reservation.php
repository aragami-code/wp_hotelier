...
<tr>
	<td style="text-align:left;font-size:15px;line-height:19px;color:#999999;font-family:Helvetica,Arial;"><?php printf( esc_html__( 'You have received a reservation from %s.', 'wp-mb_hms' ), $reservation->get_formatted_guest_full_name() ); ?></td>
</tr>
<tr>
