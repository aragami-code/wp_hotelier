...
<tr>
	<td style="text-align:left;font-size:15px;line-height:19px;color:#999999;font-family:Helvetica,Arial;"><?php printf( esc_html__( 'Hello %s, your reservation has been confirmed. Your reservation details are shown below for your reference.', 'wp-mb_hms' ), $reservation->get_formatted_guest_full_name() ); ?></td>
</tr>
<tr>
...
<tr>
	<td style="text-align:left;font-size:14px;line-height:20px;color:#999999;"><strong style="color:#444444;font-family:Helvetica,Arial;"><?php esc_html_e( 'Check-in:', 'wp-mb_hms' ); ?></strong> <?php echo esc_html( $reservation->get_formatted_checkin() ); ?> (<?php echo esc_html( HTL_Info::get_hotel_checkin() ); ?>)</td>
</tr>
<tr>
	<td style="text-align:left;font-size:14px;line-height:20px;color:#999999;font-family:Helvetica,Arial;"><strong style="color:#444444;"><?php esc_html_e( 'Check-out:', 'wp-mb_hms' ); ?></strong> <?php echo esc_html( $reservation->get_formatted_checkout() ); ?> (<?php echo esc_html( HTL_Info::get_hotel_checkout() ); ?>)</td>
</tr>
<tr>
...
<?php do_action( 'mb_hms_email_reservation_instructions', $reservation, $sent_to_admin ); ?>
