...
echo sprintf( esc_html__( 'Hello %s, your reservation has been cancelled. The reservation was as follows.', 'wp-mb_hms' ), $reservation->get_formatted_guest_full_name() ) . "\n\n";
