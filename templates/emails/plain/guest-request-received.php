...
echo esc_html__( 'Thank you, your booking request has been received and is now being processed. Your reservation details are shown below for your reference.', 'wp-mb_hms' ) . "\n\n";
