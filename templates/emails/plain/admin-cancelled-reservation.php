...
echo sprintf( esc_html__( 'The reservation #%d from %s has been cancelled. The reservation was as follows.', 'wp-mb_hms' ), $reservation->id, $reservation->get_formatted_guest_full_name() ) . "\n\n";
