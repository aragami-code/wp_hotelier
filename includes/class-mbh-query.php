...
class MBH_Query {
	...
	public function init_query_vars() {
		...
		$this->query_vars = array(
			'pay-reservation'      => mbh_get_option( 'pay_endpoint', 'pay-reservation' ),
			'reservation-received' => mbh_get_option( 'reservation_received', 'reservation-received' ),
		);
	}
	...
	public function get_endpoint_title( $endpoint ) {
		...
		switch ( $endpoint ) {
			case 'pay-reservation' :
				$title = esc_html__( 'Pay reservation', 'wp-mb_hms' );
			break;
			case 'reservation-received' :
				$title = esc_html__( 'Reservation received', 'wp-mb_hms' );
			break;
			default :
				$title = '';
			break;
