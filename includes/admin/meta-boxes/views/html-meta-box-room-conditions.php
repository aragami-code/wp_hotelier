			...
			for ( $i = 1; $i <= $conditions_lenght; $i++ ) :
				...
				<tr class="room-condition" data-key="<?php echo absint( $i ); ?>">
					<td class="condition-name">
						<input type="text" name="_room_conditions[<?php echo absint( $i ); ?>][name]" value="<?php echo esc_attr( $condition_value ); ?>" placeholder="<?php esc_html_e( 'Special condition here', 'wp-mb_hms' ); ?>" />
