...
class MBH_Privacy {
	...
	public function __construct() {
		...
		include_once 'class-mbh-privacy-erasers.php';
		include_once 'class-mbh-privacy-exporters.php';
	...
	protected function init() {
		...
		$this->add_exporter( 'mb_hms-guest-reservations', __( 'Guest Reservations', 'wp-mb_hms' ), array( 'MBH_Privacy_Exporters', 'reservation_data_exporter' ) );
		$this->add_eraser( 'mb_hms-guest-reservations', __( 'Guest Reservations', 'wp-mb_hms' ), array( 'MBH_Privacy_Erasers', 'reservation_data_eraser' ) );
