...
if ( ! class_exists( 'MBH_Room_Variation' ) ) :

/**
 * HTL_Room_Variation Class
 */
class MBH_Room_Variation {
	...
	public function get_formatted_room_rate() {
		...
		$room_rate = mbh_get_formatted_room_rate( $room_rate );
	...
	public function get_regular_price( $checkin, $checkout ) {
		...
		$price = apply_filters( 'mb_hms_get_variation_regular_price', $price, $checkin, $checkout, $this );
	...
	public function get_sale_price( $checkin, $checkout ) {
		...
		$price = apply_filters( 'mb_hms_get_variation_sale_price', $price, $checkin, $checkout, $this );
	...
	public function get_seasonal_price( $checkin, $checkout = false ) {
		...
		if ( $price > 0 ) {
			return apply_filters( 'mb_hms_get_variation_seasonal_price', $price, $this );
	...
	public function is_on_sale( $checkin, $checkout ) {
		...
		return apply_filters( 'mb_hms_variation_is_on_sale', $is_on_sale, $checkin, $checkout, $this );
	}
	...
	public function get_price( $checkin, $checkout = false ) {
		...
		return apply_filters( 'mb_hms_variation_get_price', $price, $checkin, $checkout, $this );
	}
	...
	public function get_min_price_html() {
		...
		$min_price = apply_filters( 'mb_hms_variation_min_price_html', $min_price, $this );
	...
	public function get_deposit() {
		...
		return apply_filters( 'mb_hms_room_variation_deposit', $percentage, $this );
	}
	...
	public function get_formatted_deposit() {
		...
		return apply_filters( 'mb_hms_room_variation_formatted_deposit', $percentage, $this );
	}
	...
	public function get_min_nights() {
		return apply_filters( 'mb_hms_per_variation_minimum_nights', mbh_get_option( 'booking_minimum_nights', 1 ), $this );
	}
	...
	public function get_max_nights() {
		return apply_filters( 'mb_hms_per_variation_maximum_nights', mbh_get_option( 'booking_maximum_nights', 0 ), $this );
	}
}
