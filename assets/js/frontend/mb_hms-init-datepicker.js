jQuery(function ($) {
	...
	function get_data() {
		if (document.getElementById('mb_hms-datepicker-select')) {
			var checkin_val = '';
			var checkout_val = '';
			...
			$.ajax({
				url: datepicker_params.mbh_ajax_url.toString(),
				type: 'POST',
	...
	function init_datepicker(checkin, checkout) {
		if (document.getElementById('mb_hms-datepicker-select')) {
			var date_select_input = $('#mb_hms-datepicker-select');
			var checkin_input = $('#mb_hms-datepicker-checkin');
			var checkout_input = $('#mb_hms-datepicker-checkout');
			...
			var picker = new HotelDatepicker(document.getElementById('mb_hms-datepicker-select'), {
